ARM Embedded Toolchain 2014q3 for Arduino on Raspberry Pi
---------------------------------------------------------

This copy of the 2014q3 "arm-none-eabi-gcc" toolchain used by Arduino is slightly modified to be able to compile on Raspberry Pi.
